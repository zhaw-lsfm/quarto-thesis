...
# Verzeichnis der Abbildungen {.unnumbered .unlisted}

```{=typst}
#outline(title: none, target: figure.where(supplement: [Abbildung]))
```

# Verzeichnis der Tabellen {.unnumbered .unlisted}

```{=typst}
#outline(title: none, target: figure.where(supplement: [Tabelle]))
```
